var glm = {
    ...
    translate: function(m, tx, ty, tz) {
        return glm.multiply(m, glm.translation(tx, ty, tz));
    },

    xRotate: function(m, angleInRadians) {
        return glm.multiply(m, glm.xRotation(angleInRadians));
    },

    yRotate: function(m, angleInRadians) {
        return glm.multiply(m, glm.yRotation(angleInRadians));
    },

    zRotate: function(m, angleInRadians) {
        return glm.multiply(m, glm.zRotation(angleInRadians));
    },

    scale: function(m, sx, sy, sz) {
        return glm.multiply(m, glm.scaling(sx, sy, sz));
    },
    }; //end of glm